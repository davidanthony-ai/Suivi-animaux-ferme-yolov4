...
image_BGR = cv2.imread('images\poul_1.jpg')
...
# # Check point
# # Showing image shape
# print('Image shape:', image_BGR.shape)  # tuple of (636, 1686, 3)
...
# print('Image height={0} and width={1}'.format(h, w))  # 636 1686
...
# # Check point
# print('Image shape:', image_BGR.shape)  # (636, 1686, 3)
...
# Loading sheep and chicken classes labels from file
# Opening file
...
# # Check point
# print()
# print(layers_names_output)  # ['yolo_139', 'yolo_150', 'yolo_161']
...
cv2.imwrite('pred_image_'+str(np.random.randint(100))+'.jpg', image_BGR)
